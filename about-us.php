<?php
$page_title = "About Us - Ajaykumar Sarnaik";
$page_description = "Learn about the legacy, vision, and mission of Ajaykumar Sarnaik. Dedicated to cooperative governance and rural development in Bagalkot.";
$extra_css = '
    <style>
        :root {
            --royal-blue: #000080;
            ...
            <div class="col-lg-6 ps-8 lg-ps-15px"
                ...
                <div class="position-relative">
                    <div class="image-wrapper rounded-20px overflow-hidden box-shadow-extra-large position-relative">
                        <img src="images/new/anna-rahul.jpg" class="w-100" alt="About Ajaykumar Sarnaik">
        ...
        <div class="row row-cols-1 row-cols-lg-3 g-4" data-anime=\'{ "el" : "childs" , "translateY" : [30, 0], "opacity"
            ...
            <div class="col">
                <div class="glass-card h-100 p-0 overflow-hidden border-0">
                    <div class="position-relative">
                        <img src="images/new/sugar.jpg" class="w-100 h-250px object-fit-cover" alt="Sugar Industry">
