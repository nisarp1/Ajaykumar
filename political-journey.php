<?php
$page_title = "Political Journey - Ajaykumar Sarnaik";
$page_description = "Explore the distinguished political journey of Ajaykumar Sarnaik. From grassroots leadership to Ministerial service and Parliamentary representation.";
$extra_css = '
    <style>
        :root {
            --royal-blue: #000080;
                ...
                <div class="position-relative">
                    <div class="p-4 bg-alabaster border-radius-24px">
                        <div class="overflow-hidden border-radius-20px shadow-lg">
                            <img src="images/new/anna-rahul.jpg" class="w-100 hover-scale" alt="Grassroots Philosophy">
                        </div>
                    </div>
                    <!-- Caption Overlay -->
