<?php
$page_title = "Volunteer - Ajaykumar Sarnaik";
$page_description = "Contribute your skills and time. Join Ajaykumar Sarnaik\'s volunteer network and work towards all-round development in Bagalkot.";
$extra_css = '
    <style>
        :root {
            --royal-blue: #000080;
