...
function waQuickReply(query) {
    ...
    const replies = {
        ...
        'Constituency Office': 'The constituency office is in Bagalkot. You can call +91 98453 52310 for direct assistance.',
...
function sendAiMessage() {
    ...
    setTimeout(() => {
        ...
        if (q.includes('who') && q.includes('ajay')) {
            ...
            response = "You can contact the office at Bagalkot or email office@ajaykumarsarnaik.com. Our helpline is also available via the WhatsApp widget on the left.";
        } else {
