...
?>
<!-- Hero -->
<section class="p-0 cover-background h-800px pt-80px position-relative overflow-hidden" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/new/inner-pages-banner/bagalkot.jpg');">
        ...
        <div class="row g-4"
            ...
            <div class="col-lg-4">
                <div class="region-card shadow-lg">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/new/sugar.jpg" alt="Agriculture">
            ...
            <div class="col-lg-4">
                <div class="region-card shadow-lg">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/new/tourism.jpg" alt="Heritage">
                    <div class="region-overlay text-white">
