<?php
/*
Template Name: Voice of the People
*/
get_header(); 
$extra_css = '
    <style>
...
';
echo $extra_css;
?><section class="p-0 cover-background h-800px pt-80px position-relative overflow-hidden" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/new/inner-pages-banner/voice-of-the-people.jpg');">
        ...
        <div class="row"
            ...
            <div class="col-lg-12">
                <div class="bg-white p-5 border-radius-20px shadow-lg">
                    <?php echo do_shortcode('[contact-form-7 title="Voice of the People"]'); ?>
                </div>
            </div>
        </div>
    </div>
